          ...
          <v-col cols="12">
           ...
           <v-container fluid class="px-0" style="overflow-x: auto;">
            <v-row no-gutters justify="center">
                ...
                <v-card-title class="text-center" style="color: white !important; font-size: 0.9rem;">Semifinali</v-card-title>
                <v-card
                ...
                <!-- Colonna: Finale -->
                <v-col cols="6" class="d-flex flex-column align-center pa-1" style="margin-top: 35px;">
                <v-card-title class="text-center" style="color: white !important; font-size: 0.9rem;">Finale</v-card-title>
                <v-card
                    v-for="(quarto, index) in finali"
                    :key="'quarto-' + index"
                    class="mt-3 pa-2 text-white text-center"
                    color="rgba(0, 0, 0, 0.7)"
                    dark
...
data() {
    ...
    computed: {
        ...
        finali() {
            const v = this.vincitoriSemi;
            
            return [
                { team1: v[0], team2: v[1], data: "2025-06-29T22:30:00" }, // vincitori partite 0 e 1
            ];
        }
    },
    methods: {
