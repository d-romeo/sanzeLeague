          ...
          <v-col cols="12">
           ...
           <v-container fluid class="px-0" style="overflow-x: auto;">
            <v-row no-gutters justify="center">
                ...
                <v-card-title class="text-center" style="color: white !important; font-size: 0.9rem;">Quarti</v-card-title>
                <v-card
...
data() {
    ...
    computed: {
        ...
        semi() {
            const v = this.vincitoriQuarti;
            
            return [
                { team1: v[0], team2: v[1], data: "2025-06-29T20:45:00" }, // vincitori partite 0 e 1
                { team1: v[2], team2: v[3], data: "2025-06-29T21:30:00" }, // vincitori partite 2 e 3
            ];
        }
    },
    methods: {
